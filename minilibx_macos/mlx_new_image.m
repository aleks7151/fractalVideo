...
void    mlx_put_image_to_window(mlx_ptr_t *mlx_ptr, mlx_win_list_t *win_ptr, mlx_img_list_t *img_ptr, int x, int y, long double w, long double h, float c, float v, int cycle, int color, long double sh_x, long double sh_y, char fractal, int width, int height)
{
  mlx_img_ctx_t	*imgctx;
  ...
  [(id)(win_ptr->winid) mlx_gl_draw_img:img_ptr andCtx:imgctx andX:x andY:y w0:w h0:h c0:c v0:v cycle0:cycle color0:color sh_x0:sh_x sh_y0:sh_y fractal0:fractal width0:width height0:height];
