...
- (void) mlx_gl_draw_img:(mlx_img_list_t *)img andCtx:(mlx_img_ctx_t *)imgctx andX:(int)x andY:(int)y w0:(long double)w h0:(long double)h c0:(float)c v0:(float)v cycle0:(int)cycle color0:(int)color sh_x0:(long double)sh_x sh_y0:(long double)sh_y fractal0:(char)fractal width0:(int)width height0:(int)height
{
  ...
  glUniform1f(glGetUniformLocation(glsl.image_program, "w"), w);
  glUniform1f(glGetUniformLocation(glsl.image_program, "h"), h);
  glUniform1f(glGetUniformLocation(glsl.image_program, "c"), c);
  glUniform1f(glGetUniformLocation(glsl.image_program, "v"), v);
  glUniform1i(glGetUniformLocation(glsl.image_program, "cycle"), cycle);
  glUniform1i(glGetUniformLocation(glsl.image_program, "color"), color);
  glUniform1f(glGetUniformLocation(glsl.image_program, "sh_x"), sh_x);
  glUniform1f(glGetUniformLocation(glsl.image_program, "sh_y"), sh_y);
  if (fractal == 'j')
      glUniform1i(glGetUniformLocation(glsl.image_program, "fractal"), 1);
  else if (fractal == 'm')
      glUniform1i(glGetUniformLocation(glsl.image_program, "fractal"), 2);
  else if (fractal == 'q')
      glUniform1i(glGetUniformLocation(glsl.image_program, "fractal"), 3);
  else if (fractal == 'w')
      glUniform1i(glGetUniformLocation(glsl.image_program, "fractal"), 4);
  glUniform1f(glGetUniformLocation(glsl.image_program, "width"), width);
  glUniform1f(glGetUniformLocation(glsl.image_program, "height"), height);
